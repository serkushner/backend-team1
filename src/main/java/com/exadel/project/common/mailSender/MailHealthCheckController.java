...
public class MailHealthCheckController {
    ...
    public ResponseEntity<String> sendEmail(@RequestParam(value = "email") String address,
    ...
    public ResponseEntity<String> sendEmailWithTemplate(@RequestParam(value = "email")
                                                                    String address,
                                                        @RequestParam(value = "topic",
                                                                required = false, defaultValue = "exadel emailSender") String topic,
                                                        @RequestParam(value = "text",
                                                                defaultValue = "data in template from exadel emailSender") String text) {
